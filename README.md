В ветке main реализована form login аутентификация, пользователи в ней берутся из БД(использовал Postgres) - скрипт прикреплен(script.sql) в папке ресурсов
